...
/*! \file mcp_can_dfs.h
 ...
 Difajnovi za MCP2515 za razlicite konstante
*/

#ifndef MCP_CAN_DFS_H
#define MCP_CAN_DFS_H
...
//@{
//! Pocetne vrednosti u registru pri citanju i pisanju */
...
/// Enable all transmit interrup ts  
#define MCP_TX_INT          0x1C   

/// Enable TXB0 and TXB1 interru pts
...
/// CS pin, setovanje na 0
#define MCP2515_SELECT()   LATF &= ~(1<<5) 

/// CS pin, setovanje na 1
#define MCP2515_UNSELECT() LATF |= (1<<5)
...
//@{  
//!initial value of CANAutoProcess.*/
